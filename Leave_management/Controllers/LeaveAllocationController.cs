...
namespace Leave_management.Controllers
{
	...
	public class LeaveAllocationController : Controller
	{
		...
		public LeaveAllocationController(ILeaveTypeRepository leaverepo, IMapper mapper, ILeaveAllocationRepository leaveAllocation, UserManager<Employee> userManager)
		{
		...
		{
			var leavestypes = _leaverepo.FindAll().ToList();
			var mappedLeaveTypes = _mapper.Map<List<LeaveType>, List<LeaveTypeVM>>(leavestypes);
